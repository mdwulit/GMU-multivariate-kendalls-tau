...
date: "12/18/2016"
abstract: |
  Kendell's $\tau$ is an excellent way to indicate .
...
we are assuming that there is not ties in any given dimension for all random vectors in data set. The
...
Computed counts and probabilites
